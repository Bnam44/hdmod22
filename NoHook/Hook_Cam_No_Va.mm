...
bool damage(){
    ...
    dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
        ...
        PPIL2CppImpl("Project_d.dll", "", "CameraSystem", (void *)cam, (void *)&_cam, "GetCameraHeightRateValue", 1);
        [[SliderManager sharedInstance] setupGestureRecognizer];
    });
    return hook(

            //(void *)getRealOffsetUnity(ENCRYPTOFFSET("0x668CE90")),
        (void *[]) {
            (void *)getRealOffsetUnity(ENCRYPTOFFSET("0x668CE90")),
