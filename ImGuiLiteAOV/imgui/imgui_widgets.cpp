...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    ImGui::RenderFrame(frame_bb.Min, frame_bb.Max, ImColor(15, 15, 16), false, 9.0f);
    ImGui::RenderFrame(frame_bb.Min, frame_bb.Max, ImColor(56 / 255.0f, 101 / 255.0f, 242 / 255.0f, it_anim->second.animation), false, 9.0f);
